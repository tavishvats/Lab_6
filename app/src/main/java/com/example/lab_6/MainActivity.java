...
//    private final LatLng mDestinationLatLng = new LatLng(-33.8523341, 151.2106085);
    private final LatLng mDestinationLatLng = new LatLng(43.07585143246595, -89.40434436088444);
//    private final LatLng mStartLatLng = new LatLng( 43.06954394812543, -89.3969798793729);
...
//                    mMap.addPolyline(new PolylineOptions().add(new LatLng(mStartLatLng.latitude,
//                            mStartLatLng.longitude), mDestinationLatLng));
                }
            });
        }
    }
